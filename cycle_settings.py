"""Saved preferences for the future cycle engine; no herd or alarm mutations."""
import json
import re
...
DAY_SETTINGS = (
    ...
    ('weaning_days','Sütten kesme','Buzağının doğumundan sonra sütten kesme için hedef günü belirler.',100,1,250,'weaning_enabled'),
    ...
    ('insemination_gap_days','Tohumlama kayıt aralığı','İki tohumlama kaydı arasında planlanan en kısa aralığı belirler.',7,1,180,None),
)
